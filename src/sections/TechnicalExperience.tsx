          ...
          <div className="md:col-span-2">
            <GlassCard delay={0.4} className="bg-gradient-to-br from-primary-500/10 to-accent-500/10 border-primary-500/20">
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                {['Optimización', 'Escalabilidad', 'Asincronía', 'Arquitectura'].map(tag => (
                  <span key={tag} className="px-3 py-1 text-xs font-semibold bg-white/50 dark:bg-dark-900/50 rounded-md text-primary-600 dark:text-primary-400">
                    {tag}
                  </span>
                ))}
              </div>
