...
export const Contact = () => {
  ...
  return (
    <SectionWrapper id="contact" alt maxWidth="max-w-4xl" className="text-center">
      ...
      <GlassCard className="max-w-2xl mx-auto mt-8 p-8 md:p-12">
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-10">
          <a href={PERSONAL.github} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 p-4 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
            <Github size={32} className="text-slate-700 dark:text-slate-300" />
            <span className="font-medium text-sm">GitHub</span>
          </a>
          
          <a href={PERSONAL.linkedin} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 p-4 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
