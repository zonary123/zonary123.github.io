  ...
  const skillCategories = [
    {
      ...
      icon: <Server className="text-accent-about mb-4" size={28} />,
    ...
    },
    {
      ...
      icon: <Database className="text-accent-formation mb-4" size={28} />,
    ...
    },
    {
      ...
      icon: <Layout className="text-accent-projects mb-4" size={28} />,
    ...
    },
    {
      ...
      icon: <Settings className="text-editor-muted mb-4" size={28} />,
      color: 'rgba(133,133,133,0.4)',
      border: 'border-l-[var(--editor-muted)]',
      skills: ['Git', 'NPM', 'Docker', 'Kubernetes', 'Linux', 'Windows'],
    },
    {
      title: t('skills.specialties'),
      icon: <Zap className="text-accent-skills mb-4" size={28} />,
